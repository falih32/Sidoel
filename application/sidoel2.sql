...
-- ----------------------------
BEGIN;
INSERT INTO `t_unit_terusan` VALUES ('1', 'TU Pimpinan'), ('2', 'Rumah Tangga'), ('3', 'Perlengkapan'), ('4', 'TU dan Persuratan'), ('6', 'Kepala Satpam');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_unit_tujuan` VALUES ('1', 'Menteri'), ('2', 'Staf Ahli Menteri'), ('3', 'Om Janitor ');
COMMIT;
...
-- ----------------------------
ALTER TABLE `t_unit_terusan` AUTO_INCREMENT=7;

-- ----------------------------
-- Auto increment value for `t_unit_tujuan`
-- ----------------------------
ALTER TABLE `t_unit_tujuan` AUTO_INCREMENT=6;
