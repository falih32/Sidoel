<div class="container-fluid">
    <div class="row-fluid">
    	<div class="panel panel-primary">
            ...
            <div class="panel-body text-center" id="conchart">
            	<h3>Grafik Surat Masuk dan Disposisi</h3>
				<script>
                var width = document.getElementById('conchart').offsetWidth * 0.9;
                var height = width;
...
$(document).ready(function() {
	...
	var chart1 = new Chart(canvas1).Bar(<?php echo json_encode($info); ?>,'');
